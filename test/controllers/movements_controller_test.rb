...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference("Movement.count") do
      post movements_url, params: { movement: { amount: @movement.amount, category_id: @movement.category_id, entrance_id: @movement.entrance_id, kind: @movement.kind, name: @movement.name } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { amount: @movement.amount, category_id: @movement.category_id, entrance_id: @movement.entrance_id, kind: @movement.kind, name: @movement.name } }
